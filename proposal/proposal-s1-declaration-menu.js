...
const TAG = "ProposalS1DeclarationMenu.";
export default class ProposalS1DeclarationMenu extends React.Component {
    constructor(props){
      super(props);
    ...
    //   console.log(TAG + "renderRow", viewno);
      var iconNames = ["align-justify","chain","th","files-o","pencil"];

...
var modelDef = (self) => {
 let mapp = {
  q1_ph_height : t.Number,
  q1_ph_weight : t.Number,
  q1_la_height : t.maybe(t.Number),
  q1_la_weight : t.maybe(t.Number),
...
var optionsFactory = (self)  => {
    ...
    let options = {
        ...
        auto : 'none',
        fields : {
            q1_ph_height : {factory : LocalNumber, style : {width:50} },
            q1_ph_weight : {factory : LocalNumber, style : {width:50} },
            q1_la_height : {factory : LocalNumber, style : {width:50} },
            q1_la_weight : {factory : LocalNumber, style : {width:50} },
            ...
            q2a : {factory : LocalTextbox, style : {width:100}, label: '' , onFocus : q2focus.bind(self) },
            q2b : {factory : LocalTextbox, style : {width:200} },
            q2c : {factory : LocalTextbox, style : {width:80} },
            q2d : {factory : LocalTextbox, style : {width:80} },
            q3a : {factory : LocalTextbox, style : {width:200} , onFocus : q3focus.bind(self) },
            q3b : {factory : LocalTextbox, style : {width:80} },
            q3c : {factory : LocalTextbox, style : {width:80} },
            q4a : {factory : LocalTextbox, style : {width:300}, onFocus : q4focus.bind(self)  },
            q4b : {factory : LocalTextbox, style : {width:200} },
            q4c : {factory : LocalTextbox, style : {width:50} },
            q4d : {factory : LocalTextbox, style : {width:50} },
            q7a : {factory : LocalTextbox, style : {width:80} , onFocus : q7focus.bind(self) },
            q9a : {factory : LocalTextbox, style : {width:300}, onFocus : q9focus.bind(self) },
        }
    }
    return options
}
...
var q2 = (self,inputs) => {
    return <View>
                <View style={{flexDirection:'row'}}>
                    <View style={{flexDirection:'column', flex:0.78, justifyContent:'flex-start'}}>
                ...
                <View style={{flexDirection:'row'}}>
                    ...
                    <View style={{flex: 0.1,paddingLeft:2,paddingRight:5}}>
                        <Text style={styles.text}>sudah berapa lama</Text>
                    </View>
                    <View style={{flex:0.1, paddingLeft:5}}>{inputs.q2c}</View>
                    <View style={{flex: 0.02,paddingLeft:2,paddingRight:5}}>
...
var q3 = (self,inputs) => {
    return <View>
                <View style={{flexDirection:'row'}}>
                    ...
                    <View style={{flex:0.2, paddingLeft:10}}>{inputs.q3a}</View>
...
var q4 = (self,inputs) => {
    return <View>
                ...
                <View style={{flexDirection:'row'}}>
                    ...
                    <View style={{flex:0.2, paddingLeft:10}}>{inputs.q4b}</View>
                    <View style={{flex: 0.2,paddingLeft:2,paddingRight:5}}>
                        <Text style={styles.text}>dan berapa lama pengobatan</Text>
                    </View>
                    <View style={{flex:0.05, paddingLeft:5}}>{inputs.q4c}</View>
                    <View style={{flex: 0.02,paddingLeft:2,paddingRight:5}}>
                        <Text style={styles.text}>Thn</Text>
                    </View>
                    <View style={{flex:0.05, paddingLeft:5}}>{inputs.q4d}</View>
                    <View style={{flex: 0.02,paddingLeft:2,paddingRight:5}}>
                        <Text style={styles.text}>Bln</Text>
                    </View>
...
var layout = (self) => {
    let tmpl = (locals) => {
        ...
        // debugger;
        if (self.uistate.get().proposal.s2.ui.q2_yesno) {
            q2_yesno = q2(self, inputs)
        }
        if (self.uistate.get().proposal.s2.ui.q3_yesno) {
            q3_yesno = q3(self, inputs)
        }
        if (self.uistate.get().proposal.s2.ui.q4_yesno) {
            q4_yesno = q4(self, inputs)
        }
        if (self.uistate.get().proposal.s2.ui.q7_yesno) {
            q7_yesno = q7(self, inputs)
        }
        if (self.uistate.get().proposal.s2.ui.q9_yesno) {
        ...
        return (
                ...
                <View style={{flex:1, flexDirection:'row', paddingBottom:300, marginBottom:300}} >
                    ...
                    <View style={{flexDirection:'column',  flex: 1}} >
                        ...
                        <View style={{flex:1, flexDirection:'row'}}><Text style={styles.text}> 1. Tinggi/berat badan:</Text></View>
                        <View style={{flexDirection:'row', justifyContent:'flex-start'}}>
                            <View style={{flex:0.8, paddingLeft:20, width:300}}>
                                <Text style={styles.text}>a. Calon Pemegang Polis</Text>
                            </View>
                            <View style={{flex:0.1}}>{inputs.q1_ph_height}</View>
                            <View style={{flex: 0.01,paddingLeft:2, paddingRight:5}}>
                                <Text style={styles.text}>cm</Text>
                            </View>
                            <View style={{ flex:0.1}}>{inputs.q1_ph_weight}</View>
                            <View style={{flex: 0.01,paddingLeft:2, paddingRight:5}}>
                        ...
                        <View style={{flexDirection:'row', flex:1}}>
                            <View style={{flex: 0.7,paddingLeft:20, width:300 }}>
                                <Text style={styles.text}>b. Calon Tertanggung</Text>
                            </View>
                            <View style={{flex:0.1}}>{inputs.q1_la_height}</View>
                            <View style={{flex: 0.01,paddingLeft:2, paddingRight:5}}>
                                <Text style={styles.text}>cm</Text>
                            </View>
                            <View style={{ flex:0.1}}>{inputs.q1_la_weight}</View>
                            <View style={{flex: 0.01,paddingLeft:2, paddingRight:5}}>
                                <Text style={styles.text}>Kgs</Text>
                            </View>
                        </View>
                        ...
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q3_yesno}</View>
                        </View>
                        {q3_yesno}
                        {/* question 4 */}
                        <View style={styles.separator} />
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q4_yesno}</View>
                        </View>
                        {q4_yesno}
                        {/* question 5 */}
                        <View style={styles.separator} />
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q5_yesno}</View>
                        </View>
                        {/* question 6 */}
                        <View style={styles.separator} />
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q6_yesno}</View>
                        </View>
                        {/* question 7 */}
                        <View style={styles.separator} />
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q7_yesno}</View>
                        </View>
                        {q7_yesno}
                        {/* question 8 */}
                        <View style={styles.separator} />
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q8_yesno}</View>
                        </View>
                        {/* question 9 */}
                        <View style={styles.separator} />
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q9_yesno}</View>
                        </View>
                        {q9_yesno}
                        {/* question 10 */}
                        <View style={styles.separator} />
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q10_yesno}</View>
                        </View>
                        ...
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q11_yesno}</View>
                        </View>
...
const TAG="ProposalS2StandardView.";
export default class ProposalS2StandardView extends React.Component {
  constructor(props){
    super(props);
  ...
  onFormChange(raw, path){
    ...
    if (questions.indexOf(fname) >= 0 ) {
        ...
        this.uistate.get().proposal.s2.base.questions.set(mapp).now();
        ...
        vals.refresh = true;
        vals.base_menu_items = menuitems;
  ...
  saveProposal(){
      ...
      // do some work later --
      let doc = Object.assign( {}, this.uistate.get().proposal.s2.base.questions, values );
      this.uistate.get().proposal.s2.ui.set({refresh:false}).now()
      this.uistate.get().proposal.s2.base.set({questions:doc}).now()
  ...
  render(){
    ...
    let row = Object.assign( {},this.uistate.get().proposal.s2_defaults.base_questions,
                                this.uistate.get().proposal.s2.base.questions);
    return (

...
var optionsFactory = (self)  => {
    ...
    let options = {
        ...
        fields : {
            ...
            q2 : {factory: LocalTextbox, multiline:true, style:{width:dw-200, height:200}, onFocus : () => focus(self, 'q2')},
        }
    }
    return options
}
                ...
                <View style={{flex:1, flexDirection:'column'}} >
                    ...
                    <View style={{flexDirection:'column',  flex: 1}} >
                        ...
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1}</View>
                        </View>
...
const TAG="ProposalS1PhFamilyHistoryView.";
export default class ProposalS1PhFamilyHistoryView extends React.Component {
  constructor(props){
    super(props);
  ...
  onFormChange(raw, path){
    ...
    if (questions.indexOf(fname) >= 0 ) {
        ...
        this.uistate.get().proposal.s1.ph.family_hist.questions.set(mapp).now()
  ...
  saveProposal(){
      ...
      // do some work later --
      let doc = Object.assign( {}, this.uistate.get().proposal.s1.ph.family_hist.questions, values );
      this.uistate.get().proposal.s1.ui.set({refresh:false}).now()
      this.uistate.get().proposal.s1.ph.family_hist.set({questions:doc}).now()
  ...
  render(){
    ...
    let row = Object.assign( {},this.uistate.get().proposal.s1_defaults.family_hist,
                                this.uistate.get().proposal.s1.ph.family_hist.questions);
    return (

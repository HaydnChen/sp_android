...
import {LocalSelect,LocalDate,LocalSegmentedControls,LocalNumber, LocalTextbox, LocalCheckbox, LocalPicker} from "../form/localComponents";
...
var optionsFactory = (self)  => {
    ...
    let options = {
        ...
        fields : {
            ...
            q3a : {factory : LocalPicker, style : {width:180} },
...
var q2 = (self,inputs) => {
    return <View style={{paddingLeft:20}}>
                <View style={{flexDirection:'row'}}>
                    ...
                    <View style={{flex:0.8, flexDirection: 'row', paddingLeft:0}}>
                        {inputs.q2a1}
                        <Text style={[styles.text,{paddingLeft:10, paddingRight:10}]}>bulan atau</Text>
                        {inputs.q2a2}
                        <Text style={[styles.text,{paddingLeft:10}]}>minggu</Text>
                    </View>
                </View>
                <View style={{flexDirection:'row'}}>
                    <View style={{flexDirection:'column', flex:0.2, justifyContent:'flex-start'}}>
                    ...
                    <View style={{flex:0.8, flexDirection: 'row', paddingLeft:0}}>
                        {inputs.q2a3}
                        <Text style={[styles.text,{paddingLeft:2, paddingRight:2}]}>-</Text>
                        {inputs.q2a4}
                        <Text style={[styles.text,{paddingLeft:2, paddingRight:2}]}>-</Text>
                        {inputs.q2a5}
                        <Text style={[styles.text,{paddingLeft:2, paddingRight:2}]}>(dd-mm-yyyy)</Text>
                    </View>
...
var layout = (self) => {
    let tmpl = (locals) => {
        ...
        let s2 = self.uistate.get().proposal.s1;
        let [q2_yesno] = [<View />] ;
        // debugger;
        if (self.uistate.get().proposal.s1.ui.phhealth.q2_yesno) {
        ...
        return (
                ...
                <View  style={{flex:1, flexDirection:'column'}} >
                    ...
                    <View style={{flexDirection:'column',  flex: 1}} >
                        ...
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                                        a. Mata : termasuk fungsi penglihatan
                                    </Text>
                            </View>
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1a}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1b}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1c}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1d}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1e}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1f}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1g}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1h}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1i}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1j}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1k}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1l}</View>
                        </View>
                        <View style={{flexDirection:'row'}}>
                            <View style={{flexDirection:'column', flex:0.8, justifyContent:'flex-start'}}>
                                    <Text style={[styles.smltext,{width:dw*0.85-200,paddingLeft:10}]}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q1m}</View>
                        </View>
                        ...
                        <View style={{flexDirection:'row',paddingLeft:20}}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q2d}</View>
                        </View>
                        ...
                        <View style={{flexDirection:'row',paddingLeft:20}}>
                            ...
                            <View style={{flex:0.3, paddingLeft:0}}>{inputs.q3a}</View>
                        </View>
                        <View style={{flexDirection:'row',paddingLeft:20}}>
                        ...
                        <View style={{flexDirection:'row',paddingLeft:10}}>
                            ...
                            <View style={{flex:0.10, paddingLeft:10}}>{inputs.q3b1}</View>
                            <View style={{flex: 0.1,paddingLeft:2}}>
                                <Text style={styles.text}>bulan atau</Text>
                            </View>
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q3b2}</View>
                            <View style={{flex: 0.25,paddingLeft:2}}>
                        ...
                        <View style={{flexDirection:'row',paddingLeft:10}}>
                            <View style={{flexDirection:'column', flex:0.25, justifyContent:'flex-start'}}>
                                    <Text style={[styles.text]}>
                                        Panjang / berat badan saat lahir
                                    </Text>
                            </View>
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q3c1}</View>
                            <View style={{flex: 0.05,paddingLeft:2}}>
                                <Text style={styles.text}>cm</Text>
                            </View>
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.q3c2}</View>
                        ...
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.2, paddingLeft:0}}>{inputs.q4}</View>
                        </View>
...
const TAG="ProposalS1PhHealthView.";
export default class ProposalS1PhHealthView extends React.Component {
  constructor(props){
    super(props);
  ...
  onFormChange(raw, path){
    ...
    if (questions.indexOf(fname) >= 0 ) {
        ...
        this.uistate.get().proposal.s1.ph.health.questions.set(mapp).now()
        let vals = {q2_yesno : raw['q2_yesno']}
        this.uistate.get().proposal.s1.ui.phhealth.set(vals).now();
        this.uistate.get().proposal.s1.ui.set({refresh:true}).now();
    }
  }
  alert(msg=null) {
  ...
  saveProposal(){
      ...
      // do some work later --
      let doc = Object.assign( {}, this.uistate.get().proposal.s1.ph.health.questions, values );
      this.uistate.get().proposal.s1.ui.set({refresh:false}).now()
      this.uistate.get().proposal.s1.ph.health.set({questions:doc}).now()
  ...
  render(){
    ...
    let row = Object.assign( {},this.uistate.get().proposal.s1_defaults.health_questions,
                                this.uistate.get().proposal.s1.ph.health.questions);
    return (
       <View style={{flexDirection:'column', justifyContent:'flex-start', paddingBottom:0, marginBottom:0}}>
              <View style={{flexDirection: 'row' , paddingLeft: 20 ,height:dh-200 }}>

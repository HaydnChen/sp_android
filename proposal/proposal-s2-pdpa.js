                ...
                <ScrollView ref="svpdpa" style={{flex:1, flexDirection:'column'}} >
                    ...
                    <View style={{flexDirection:'column',  flex: 1}} >
                        ...
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flex:0.1, paddingLeft:10}}>{inputs.pdpa_ok}</View>
                        </View>
...
const TAG="ProposalS2PdpaView.";
export default class ProposalS2PdpaView extends React.Component {
  constructor(props){
    super(props);
  ...
  onFormChange(raw, path){
      ...
      if (questions.indexOf(fname) >= 0 ) {
          ...
          this.uistate.get().proposal.s2.pdpa.questions.set(mapp).now()
  ...
  saveProposal(){
      ...
      // do some work later --
      let doc = Object.assign( {}, this.uistate.get().proposal.s2.pdpa.questions, values );
      this.uistate.get().proposal.s2.ui.set({refresh:false}).now()
      this.uistate.get().proposal.s2.pdpa.set({questions:doc}).now()
      this.props.fns.saveProposal();
  }

  render(){
    Form.stylesheet = formstyles;
    let row = Object.assign( {},this.uistate.get().proposal.s2_defaults.pdpa,
                                this.uistate.get().proposal.s2.pdpa.questions);
    return (
       <View style={{flexDirection:'column', justifyContent:'flex-start', paddingBottom:0, marginBottom:0}}>
              ...
              <View ref="actionButton" style={[styles.overlay],{left:((dw*0.85)-80), top:-(dh/2)-100}}>
